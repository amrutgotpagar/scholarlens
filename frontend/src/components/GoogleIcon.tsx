/** lucide-react ships no brand icons in this version, so the standard Google "G"
 * mark is hand-coded here — a static, well-known public logo SVG, not a security
 * concern to inline directly. */
